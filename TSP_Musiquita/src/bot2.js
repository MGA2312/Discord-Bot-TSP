  ...
  if(!message.content.startsWith(prefix) || message.author.bot) return;
    ...
    case "help":
      message.channel.send(`${prefix}play:reproduce links o busca en youtube <br>
                            ${prefix}pause:pausa la reproducción <br>
                            ${prefix}skip:saltea la reproducción actual por la proxima en la lista de reproducciòn o cola <br>
                            ${prefix}resume:vuelve a reproducir<br>
                            ${prefix}stop:detiene la reproducción<br>` );
    break;
    //no disponible
    default:
